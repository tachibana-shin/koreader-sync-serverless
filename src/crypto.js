...
export async function hashPassword(password, username, pepper, iterations = DEFAULT_PBKDF2_ITERATIONS) {
    return pbkdf2(password, `${username}:${pepper}`, iterations);
}
export async function verifyPassword(password, username, pepper, storedHash, iterations = DEFAULT_PBKDF2_ITERATIONS) {
